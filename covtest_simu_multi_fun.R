...
aas=c(0.6,0.7,0.8,0.9)#(0:5)/5
rrs=c(0.6,0.7,0.8,0.9)#(4:10)/10
ses=1:3
ns=c(500,1000,2000,5000)#c(2,4,6,8,10,20,30,40,50)*100
ps=c(50,100,150,200,300)#c(50,100,150,200,500,1000)
