% Created by tikzDevice version 0.10.1 on 2018-02-25 19:16:52
...
\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (168.93,185.68) rectangle (209.68,156.88);
\definecolor{drawColor}{RGB}{0,0,255}

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (176.13,176.08) -- (190.53,176.08);
\definecolor{drawColor}{RGB}{255,165,0}

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (176.13,166.48) -- (190.53,166.48);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (197.73,173.32) {$\lambda_1^*$};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.80] at (197.73,163.72) {$\lambda_2^*$};
\end{scope}
\end{tikzpicture}
